...
def make_test_lines(input_path: Path) -> list[TestInputLine | TestOutputLine]:
    return [
        ...
        TestOutputLine('@200: #1 SENT ALERT TO #2: Badness', 10.0),
        TestOutputLine('@300: #2 RECEIVED ALERT FROM #1: Badness', 10.0),
        TestOutputLine('@300: #2 SENT ALERT TO #1: Badness', 10.0),
        TestOutputLine('@400: #1 RECEIVED ALERT FROM #2: Badness', 10.0),
        TestOutputLine('@400: #1 SENT ALERT TO #2: Badness', 10.0),
        TestOutputLine('@450: #1 SENT CANCELLATION TO #2: Badness', 10.0),
        TestOutputLine('@500: #2 RECEIVED ALERT FROM #1: Badness', 10.0),
        TestOutputLine('@500: #2 SENT ALERT TO #1: Badness', 10.0),
        TestOutputLine('@550: #2 RECEIVED CANCELLATION FROM #1: Badness', 10.0),
        TestOutputLine('@550: #2 SENT CANCELLATION TO #1: Badness', 10.0),
        TestOutputLine('@600: #1 RECEIVED ALERT FROM #2: Badness', 10.0),
        TestOutputLine('@650: #1 RECEIVED CANCELLATION FROM #2: Badness', 10.0),
        TestOutputLine('@60000: END', 10.0),
        TestEndOfOutput(2.0)
    ]
